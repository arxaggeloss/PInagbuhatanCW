...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (password_verify($new_password, $last_password)) {
        ...
        if (sendOTP($email, $otp)) {
            ...
            $_SESSION['show_otp_input'] = true; // Set flag to show OTP input
        } else {
...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <?php if ($success_message !== ""): ?>
            <?php if (strpos($success_message, "successful") === false && isset($_SESSION['show_otp_input']) && $_SESSION['show_otp_input']): ?>
